        ...
        children: [
          ...
          Center(
            child: Column(
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: const CircleAvatar(
                        ...
                        backgroundImage: NetworkImage('https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&q=80'), // Imagen de perfil del administrador
                      ),
                    ),
                    Container(
                ...
                const Text(
                  'Logística FuelTrack S.A.',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textDark),
                ),
                const SizedBox(height: 4),
                const Text(
                  'Administrador Principal: Carlos Méndez',
          ...
          _buildSectionCard(
            ...
            child: Column(
              ...
              children: [
                _buildInfoField('Razón Social', 'FuelTrack Solutions Internacional'),
                const SizedBox(height: 16),
                _buildInfoField('RFC / Identificación Fiscal', 'FSI990101TX4'),
                const SizedBox(height: 16),
                _buildInfoField('Correo Corporativo', 'admin@fueltrack-corp.com'),
                const SizedBox(height: 16),
