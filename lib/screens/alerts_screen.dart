...
class _AlertsScreenState extends State<AlertsScreen> {
  ...
  String _selectedFilter = 'Todas'; // Filtros: 'Todas', 'Críticas', 'Advertencias'
  ...
  Future<void> _loadAlertsState() async {
  ...
  // ==========================================
              const SizedBox(width: 8),
              GestureDetector(
                onTap: () => setState(() => _selectedFilter = 'Críticas'),
                child: _buildFilterChip('Críticas', _selectedFilter == 'Críticas', Icons.warning_rounded, iconColor: AppColors.error),
              ),
              const SizedBox(width: 8),
              GestureDetector(
                onTap: () => setState(() => _selectedFilter = 'Advertencias'),
                child: _buildFilterChip('Advertencias', _selectedFilter == 'Advertencias', Icons.warning_amber_rounded, iconColor: const Color(0xFFF39C12)),
              ),
            ],
          ),
        ),
        ...
        // Tarjeta 1: Crítica
        if (_selectedFilter == 'Todas' || _selectedFilter == 'Críticas') ...[
          _buildAlertCard(
        ...
        if (_selectedFilter == 'Todas' || _selectedFilter == 'Advertencias') ...[
          _buildAlertCard(
