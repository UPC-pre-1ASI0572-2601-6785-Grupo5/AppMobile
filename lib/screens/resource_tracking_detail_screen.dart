                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: const [
                                  ...
                                  SizedBox(height: 6),
                                  Text('ESTADO: CRÍTICO', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.error, letterSpacing: 0.5)),
                                ],
                              ),
                            ),
                          ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Área de la gráfica dibujada con CustomPaint
                  Container(
                    height: 120,
                    width: double.infinity,
                    decoration: BoxDecoration(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(
                  ...
                  image: NetworkImage('https://images.unsplash.com/photo-1581094288338-2314dddb7ece?w=800&q=80'),
                  fit: BoxFit.cover,
...
// ===============================================
// DIBUJO DE LA GRÁFICA ROJA (CustomPaint)
// ===============================================
class _PressureDropChartPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    // 1. DIBUJAR LA LÍNEA ROJA
    ...
    // 2. DIBUJAR EL DEGRADADO ROJO DEBAJO DE LA LÍNEA
    ...
    // 3. DIBUJAR UN PUNTO EN LA CAÍDA (Opcional, le da buen toque)
